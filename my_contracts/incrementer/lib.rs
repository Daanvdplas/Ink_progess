...
mod incrementer {
    ...
    impl Incrementer {
        ...
        /// Constructor that initializes the `i32` value to `false`.
        ///
        ...
        /// This one flips the value of the stored `i32` from `true`
    ...
    mod tests {
        ...
        #[ink::test]
        fn it_works() {
            let mut incrementer = Incrementer::new(8);
            assert_eq!(incrementer.get(), 8);
            incrementer.increment();
            assert_eq!(incrementer.get(), 9);
        }
    }
