...
mod multisig {
    ...
    mod tests {
        ...
        fn default_works() {
            ...
            assert_eq!(multisig.get(), false);
        }

        /// We test a simple use case of our contract.
        #[ink::test]
        fn it_works() {
            let mut multisig = Multisig::new(false);
            assert_eq!(multisig.get(), false);
            multisig.flip();
            assert_eq!(multisig.get(), true);
        }
    }
    ...
    mod e2e_tests {
        ...
        async fn it_works(mut client: ink_e2e::Client<C, E>) -> E2EResult<()> {
            ...
            let contract_account_id = client
                .instantiate("multisig", &ink_e2e::bob(), constructor, 0, None)
                .await
                .expect("instantiate failed")
                .account_id;
